...
\begin{questions}
    ...
    \begin{parts}
        ...
        \solution{%
        According to \url{http://wiki.gis.com/wiki/index.php/Decimal_degrees},\\ 7 significant digits are required to have an accuracy of 1.11 centimeters.
        ...
        \solution{
            Because we know at least 8 significant digits are necessary for under 1 centimeter accuracy for the degree-decimal format and $1 \:\text{[deg]} = 60\: \text{[arc-minutes]}$ and because $1 \:\text{[deg]} = 3600\: \text{[arc-seconds]}$, we can say that 4 significant digits of precision are necessary when in the DMS format.
        }
    \end{parts}
    ...
    \begin{parts}
        ...
        \solution{
            Standing on the top of the graduate buisness building, I was able to make out Davis Hall, Samford Hall, Jordan-Hare Stadium, and the basketball arena. From these four lines of bearing I was able to determine my to position to be roughly $32.606^o$ N and $84.490^o$ W. See table \ref{table:1} for the determination of position using a different number of lines of bearing.
            \begin{figure}[!h]
                \centering
                \includegraphics[width=.4\linewidth]{IMG_0025 2022-08-30 03_13_02.jpg}
            \end{figure}

            \begin{table}[h!]\label{tbl:1}
                \caption{Estimated longitude and latitude at different lines of bearing}
                \label{table:1}
                \centering
                \begin{tabular}{|c|c|c|c|c|}
                    \hline
                                                   & \multicolumn{3}{|c|}{Number of Lines of Bearing} &                               \\
                    \hline
                                                   & 2                                                & 3       & 4       & True      \\
                    \hline
                    Latitude                       & 32.604                                           & 32.6049 & 32.6051 & 32.605556 \\
                    \hline
                    Longitude                      & 84.4897                                          & 84.489  & 84.4901 & 85.49     \\
                    \hline
                    Accuracy (sig figs) [Lat/Long] & 2/1                                              & 2/1     & 3/2     & N/A       \\
                    \hline
                \end{tabular}
            \end{table}
        }
    ...
    \begin{parts}
        ...
        \solution{%
            We can use all three measurements to estimate our clock bias and position in a similiar fashion to part (c), but in matrix form.
        ...
        \solution{%
            I don't think the solution would be affected at all. Because you know the exact clock biases for the entire system, you would simply add them in when collecting your measurements. If you did't have an idea about the clock biases of the buses, more measurements would be needed to calculate the effective clock bias of your watch.
        }
        ...
        \solution{%
            We could not estimate our position and clock bias from the yellow cabs. Originally, I thought that one could count the number of yellow cabs that passed while over on the shoulder, however, this is not correct as an infinite number of yellow cabs would pass. You would know the exact frequency of the yellow cabs, but you would not know when the yellow cabs started or ended. The addition of the green cabs would not help you either as they have no correlation with the yellow cabs. You need to know more information such as an odometer measurement or the clock bias of one's watch to determine your position, which is not available for this problem.
        }
    \end{parts}
\end{questions}
\end{document}