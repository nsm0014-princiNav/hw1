...
\begin{questions}
    ...
    \begin{parts}
        ...
        \solution{
        According to \url{http://wiki.gis.com/wiki/index.php/Decimal_degrees}, 7 significant digits are required to have an accuracy of 1.11 centimeters. We can layout conversion factors to confirm this.
        \begin{equation}
            \begin{split}
                \frac{1'\;[lat]}{1\;[nm]} & = \frac{1'\;[lat]}{1852\;[m]}\\
            \end{split}
        \end{equation}
        \begin{equation}
            \begin{split}
                1852\;[m]\frac{100 [cm]}{1 [m]} & = 185,200\; [cm]\\
                \frac{1'\;[lat]}{185,200\; [cm]} & = 5.399568 \times 10^{-6}\\
            \end{split}
        \end{equation}
        Because $5.39956803 \times 10^{-6}$ minutes of latitude is necessary for a $1\;[cm]$ of distance
        }
