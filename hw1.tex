...
\begin{questions}
    ...
    \begin{parts}
        ...
        \solution{
            Because we know at least 8 significant digits are necessary for under 1 centimeter accuracy for the degree-decimal format and $1 \:\text{[deg]} = 60\: \text{[arc-minutes]}$, we can say that 9 significant digits of precision are necessary for an arc-minutes format. Furthermore, because 3600 arc-seconds occupy 1 degree of latitude, we can say the 10 significant digits of precision are necessary when in the arc-seconds format.
        }
    \end{parts}
