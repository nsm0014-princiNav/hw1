...
\begin{questions}
    ...
    \begin{parts}
        ...
        \solution{%
            ...
            \begin{equation}
                \begin{split}
                    s_1 & = v_{red}(t_{watch} + b_{watch_1})\\
                    b_{watch} & = \frac{s_1 - v_{red}t_{watch_1}}{v_{red}}\\
                \end{split}
            \end{equation}
            \begin{equation}
                \begin{split}
                    s_2 & = -v_{blue}(t_{watch} + b_{watch}) + 120\;[km]\\
                    b_{watch} & = \frac{v_{blue}t_{watch_2} + s_2 - 120}{-v_{blue}}\\
                \end{split}
            \end{equation}
            \begin{equation}
                \begin{split}
                    \frac{s_1 - v_{red}t_{watch_1}}{v_{red}} & = \frac{v_{blue}t_{watch_2} + s_2 - 120}{-v_{blue}}\\
                    \frac{56 - 3\cdot 21}{3} & = \frac{2.5\cdot25 + s_2 - 120}{-2.5}\\
                    s_2 = 63\frac{1}{3}[km]\\
                \end{split}
            \end{equation}
        }
