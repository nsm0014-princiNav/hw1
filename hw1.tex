...
\begin{questions}
    ...
    \begin{parts}
        ...
        \solution{%
            We can estimate our position and clock bias by simply counting the number of cars. Because the cars are traveling at an exact time and at an exact speed, with no noise, there should be no variation in the measurements. The addition of the green cars would help confirm your solution from the just the yellow vehicles, and the system would actually become
